...
in
{
  options.stuffs.oh-my-posh = {
    ...
    enableBashIntegration = lib.mkEnableOption "bash integration for oh-my-posh" // {
      default = true;
    };
    enableFishIntegration = lib.mkEnableOption "fish integration for oh-my-posh" // {
      default = true;
    };
    enableZshIntegration = lib.mkEnableOption "zsh integration for oh-my-posh" // {
      default = true;
    };
  };
