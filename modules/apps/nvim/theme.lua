...
hi('MiniStatuslineModeNormal', { fg = "{{ background }}", bg = "{{ cursor }}" })
hi('MiniStatuslineModeInsert', { fg = "{{ background }}", bg = "{{ color10 }}" })
hi('MiniStatuslineModeVisual', { fg = "{{ background }}", bg = "{{ color13 }}" })
hi('MiniStatuslineModeReplace', { fg = "{{ background }}", bg = "{{ color9 }}" })
hi('MiniStatuslineModeCommand', { fg = "{{ background }}", bg = "{{ color14 }}" })
hi('MiniStatuslineModeOther', { fg = "{{ background }}", bg = "{{ color8 }}" })
