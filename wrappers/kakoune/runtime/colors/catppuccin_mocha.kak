...
declare-option -hidden str rosewater "rgb:f5e0dc"
declare-option -hidden str flamingo  "rgb:f2cdcd"
declare-option -hidden str pink      "rgb:f5c2e7"
declare-option -hidden str mauve     "rgb:cba6f7"
declare-option -hidden str red       "rgb:f38ba8"
declare-option -hidden str maroon    "rgb:eba0ac"
declare-option -hidden str peach     "rgb:fab387"
declare-option -hidden str yellow    "rgb:f9e2af"
declare-option -hidden str green     "rgb:a6e3a1"
declare-option -hidden str teal      "rgb:94e2d5"
declare-option -hidden str sky       "rgb:89dceb"
declare-option -hidden str sapphire  "rgb:74c7ec"
declare-option -hidden str blue      "rgb:89b4fa"
declare-option -hidden str lavender  "rgb:b4befe"
declare-option -hidden str text      "rgb:cdd6f4"
declare-option -hidden str subtext1  "rgb:bac2de"
declare-option -hidden str subtext0  "rgb:a6adc8"
declare-option -hidden str overlay2  "rgb:9399b2"
declare-option -hidden str overlay1  "rgb:7f849c"
declare-option -hidden str overlay0  "rgb:6c7086"
declare-option -hidden str surface2  "rgb:585b70"
declare-option -hidden str surface1  "rgb:45475a"
declare-option -hidden str surface0  "rgb:313244"
declare-option -hidden str base      "rgb:1e1e2e"
declare-option -hidden str mantle    "rgb:181825"
declare-option -hidden str crust     "rgb:11111b"
